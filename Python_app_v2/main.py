...
class MainWindow(QWidget):
    def __init__(self, *args, **kwargs):
        ...
        label_text = "Battery voltage: " + str(dm.battery_level_value).strip() + "%"
    ...
    def change_date_range(self, i):
        # change the data lists
        self.current_range = i
        if(self.predictions == False):
            dm.change_date_range(self.current_range, False)
        else:
            #with predictions on
            dm.change_date_range(self.current_range, True)
